...
\cventry{2018--2022}{Vietnam National University Ho Chi Minh City - University of Science}{}{}{}{Bachelor’s Degree in Computer Science\\ \textit{Published 2 research papers in AI (SRGAN \& Video Classification) at NAFOSTED NICS and MediaEval 2020.}}
...
\cventry{May 2021 -- Nov 2021}{Software Engineer Intern}{VNG Corporation}{HCMC}{}{
    \begin{itemize}
...
\cvitem{}{
    \begin{itemize}
        ...
        \item \textbf{Technologies:} Linux, Docker, Prometheus, Thanos, Apache Thrift, Kafka.
        \item \textbf{Core Technologies:} Distributed Systems, Data Structures/Algorithms, System Reliability Engineering.
    \end{itemize}
}

\section{Projects}
\cventry{2020 -- 2021}{Free Contest}{Backend Developer \& Problem Setter}{}{}{Designed and developed API servers (TypeScript, ExpressJS, MySQL) and prepared competitive programming problems for weekly contests.}
